...
/** Matrix of size: 21 x 43 (row major format)
 * 
...
/** Column vector of size: 2641 */
real_t objAuxVar[ 2641 ];
...
/** Matrix of size: 180 x 60 (row major format) */
real_t A[ 10800 ];
