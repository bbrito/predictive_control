...
#def __init__():
'''
a Python wrapper for a fast solver generated by FORCES Pro v2.0.0
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['x0'] - column vector of length 180
       PARAMS['xinit'] - column vector of length 6
       PARAMS['all_parameters'] - column vector of length 6800
...
#	def from_param(self):
#		return self
	_fields_ = [('x0', ctypes.c_double * 180),
('xinit', ctypes.c_double * 6),
('all_parameters', ctypes.c_double * 6800),
]
