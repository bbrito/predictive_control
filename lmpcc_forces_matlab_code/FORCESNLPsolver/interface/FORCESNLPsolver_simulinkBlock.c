...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 0 */
    ssSetInputPortMatrixDimensions(S,  0, 105, 1);
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 870, 1);
	...
	/* initialize output ports - there are 15 in total */
