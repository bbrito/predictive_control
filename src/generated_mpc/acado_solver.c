...
a[6] = (a[2]+(a[3]*a[5]));
a[7] = ((real_t)(1.0000000000000000e+00)/((od[16]+od[11])*(od[16]+od[11])));
a[8] = (a[6]*a[7]);
a[9] = (a[8]*a[1]);
a[10] = (sin(od[15]));
a[11] = (a[0]*a[10]);
a[12] = (cos(od[15]));
a[13] = (a[11]+(a[3]*a[12]));
a[14] = ((real_t)(1.0000000000000000e+00)/((od[17]+od[11])*(od[17]+od[11])));
a[15] = (a[13]*a[14]);
a[16] = (a[9]+(a[15]*a[10]));
a[17] = (a[16]*a[0]);
a[18] = (a[8]*a[5]);
...
acadoWorkspace.objValueIn[3] = acadoVariables.od[760];
acadoWorkspace.objValueIn[4] = acadoVariables.od[761];
acadoWorkspace.objValueIn[5] = acadoVariables.od[762];
acadoWorkspace.objValueIn[6] = acadoVariables.od[763];
acadoWorkspace.objValueIn[7] = acadoVariables.od[764];
acadoWorkspace.objValueIn[8] = acadoVariables.od[765];
acadoWorkspace.objValueIn[9] = acadoVariables.od[766];
acadoWorkspace.objValueIn[10] = acadoVariables.od[767];
acadoWorkspace.objValueIn[11] = acadoVariables.od[768];
acadoWorkspace.objValueIn[12] = acadoVariables.od[769];
acadoWorkspace.objValueIn[13] = acadoVariables.od[770];
acadoWorkspace.objValueIn[14] = acadoVariables.od[771];
acadoWorkspace.objValueIn[15] = acadoVariables.od[772];
acadoWorkspace.objValueIn[16] = acadoVariables.od[773];
acadoWorkspace.objValueIn[17] = acadoVariables.od[774];
acadoWorkspace.objValueIn[18] = acadoVariables.od[775];
acadoWorkspace.objValueIn[19] = acadoVariables.od[776];
acadoWorkspace.objValueIn[20] = acadoVariables.od[777];
acadoWorkspace.objValueIn[21] = acadoVariables.od[778];
...
acadoWorkspace.conValueIn[3] = acadoWorkspace.y[lRun2 + 160];
...
{
acadoWorkspace.H[(iRow * 160) + (iCol * 2)] = + Gu1[0]*Gu2[0] + Gu1[2]*Gu2[2] + Gu1[4]*Gu2[4];
acadoWorkspace.H[(iRow * 160) + (iCol * 2 + 1)] = + Gu1[0]*Gu2[1] + Gu1[2]*Gu2[3] + Gu1[4]*Gu2[5];
acadoWorkspace.H[(iRow * 160 + 80) + (iCol * 2)] = + Gu1[1]*Gu2[0] + Gu1[3]*Gu2[2] + Gu1[5]*Gu2[4];
acadoWorkspace.H[(iRow * 160 + 80) + (iCol * 2 + 1)] = + Gu1[1]*Gu2[1] + Gu1[3]*Gu2[3] + Gu1[5]*Gu2[5];
}
...
{
acadoWorkspace.H[iRow * 162] = + Gu1[0]*Gu2[0] + Gu1[2]*Gu2[2] + Gu1[4]*Gu2[4] + R11[0];
acadoWorkspace.H[iRow * 162 + 1] = + Gu1[0]*Gu2[1] + Gu1[2]*Gu2[3] + Gu1[4]*Gu2[5] + R11[1];
acadoWorkspace.H[iRow * 162 + 80] = + Gu1[1]*Gu2[0] + Gu1[3]*Gu2[2] + Gu1[5]*Gu2[4] + R11[2];
acadoWorkspace.H[iRow * 162 + 81] = + Gu1[1]*Gu2[1] + Gu1[3]*Gu2[3] + Gu1[5]*Gu2[5] + R11[3];
}
...
{
acadoWorkspace.A[(row * 80 + 6400) + (col * 2)] = + Hx[0]*E[0] + Hx[1]*E[2] + Hx[2]*E[4];
acadoWorkspace.A[(row * 80 + 6400) + (col * 2 + 1)] = + Hx[0]*E[1] + Hx[1]*E[3] + Hx[2]*E[5];
}
...
{ 3, 4, 6, 7, 9, 10, 12, 13, 15, 16, 18, 19, 21, 22, 24, 25, 27, 28, 30, 31, 33, 34, 36, 37, 39, 40, 42, 43, 45, 46, 48, 49, 51, 52, 54, 55, 57, 58, 60, 61, 63, 64, 66, 67, 69, 70, 72, 73, 75, 76, 78, 79, 81, 82, 84, 85, 87, 88, 90, 91, 93, 94, 96, 97, 99, 100, 102, 103, 105, 106, 108, 109, 111, 112, 114, 115, 117, 118, 120, 121 };
...
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ ((((((lRun3) - (lRun2)) + (40)) - (1)) * (3)) * (2)) + (0) ]), acadoWorkspace.W1 );
...
{
lRun3 = (((lRun2) * (lRun2 * -1 + 79)) / (2)) + (lRun1);
lRun4 = lRun1 + 1;
...
acadoWorkspace.A[6482] = acadoWorkspace.evHu[2];
acadoWorkspace.A[6483] = acadoWorkspace.evHu[3];
acadoWorkspace.A[6564] = acadoWorkspace.evHu[4];
acadoWorkspace.A[6565] = acadoWorkspace.evHu[5];
acadoWorkspace.A[6646] = acadoWorkspace.evHu[6];
acadoWorkspace.A[6647] = acadoWorkspace.evHu[7];
acadoWorkspace.A[6728] = acadoWorkspace.evHu[8];
acadoWorkspace.A[6729] = acadoWorkspace.evHu[9];
acadoWorkspace.A[6810] = acadoWorkspace.evHu[10];
acadoWorkspace.A[6811] = acadoWorkspace.evHu[11];
acadoWorkspace.A[6892] = acadoWorkspace.evHu[12];
acadoWorkspace.A[6893] = acadoWorkspace.evHu[13];
acadoWorkspace.A[6974] = acadoWorkspace.evHu[14];
acadoWorkspace.A[6975] = acadoWorkspace.evHu[15];
acadoWorkspace.A[7056] = acadoWorkspace.evHu[16];
acadoWorkspace.A[7057] = acadoWorkspace.evHu[17];
acadoWorkspace.A[7138] = acadoWorkspace.evHu[18];
acadoWorkspace.A[7139] = acadoWorkspace.evHu[19];
acadoWorkspace.A[7220] = acadoWorkspace.evHu[20];
acadoWorkspace.A[7221] = acadoWorkspace.evHu[21];
acadoWorkspace.A[7302] = acadoWorkspace.evHu[22];
acadoWorkspace.A[7303] = acadoWorkspace.evHu[23];
acadoWorkspace.A[7384] = acadoWorkspace.evHu[24];
acadoWorkspace.A[7385] = acadoWorkspace.evHu[25];
acadoWorkspace.A[7466] = acadoWorkspace.evHu[26];
acadoWorkspace.A[7467] = acadoWorkspace.evHu[27];
acadoWorkspace.A[7548] = acadoWorkspace.evHu[28];
acadoWorkspace.A[7549] = acadoWorkspace.evHu[29];
acadoWorkspace.A[7630] = acadoWorkspace.evHu[30];
acadoWorkspace.A[7631] = acadoWorkspace.evHu[31];
acadoWorkspace.A[7712] = acadoWorkspace.evHu[32];
acadoWorkspace.A[7713] = acadoWorkspace.evHu[33];
acadoWorkspace.A[7794] = acadoWorkspace.evHu[34];
acadoWorkspace.A[7795] = acadoWorkspace.evHu[35];
acadoWorkspace.A[7876] = acadoWorkspace.evHu[36];
acadoWorkspace.A[7877] = acadoWorkspace.evHu[37];
acadoWorkspace.A[7958] = acadoWorkspace.evHu[38];
acadoWorkspace.A[7959] = acadoWorkspace.evHu[39];
acadoWorkspace.A[8040] = acadoWorkspace.evHu[40];
acadoWorkspace.A[8041] = acadoWorkspace.evHu[41];
acadoWorkspace.A[8122] = acadoWorkspace.evHu[42];
acadoWorkspace.A[8123] = acadoWorkspace.evHu[43];
acadoWorkspace.A[8204] = acadoWorkspace.evHu[44];
acadoWorkspace.A[8205] = acadoWorkspace.evHu[45];
acadoWorkspace.A[8286] = acadoWorkspace.evHu[46];
acadoWorkspace.A[8287] = acadoWorkspace.evHu[47];
acadoWorkspace.A[8368] = acadoWorkspace.evHu[48];
acadoWorkspace.A[8369] = acadoWorkspace.evHu[49];
acadoWorkspace.A[8450] = acadoWorkspace.evHu[50];
acadoWorkspace.A[8451] = acadoWorkspace.evHu[51];
acadoWorkspace.A[8532] = acadoWorkspace.evHu[52];
acadoWorkspace.A[8533] = acadoWorkspace.evHu[53];
acadoWorkspace.A[8614] = acadoWorkspace.evHu[54];
acadoWorkspace.A[8615] = acadoWorkspace.evHu[55];
acadoWorkspace.A[8696] = acadoWorkspace.evHu[56];
acadoWorkspace.A[8697] = acadoWorkspace.evHu[57];
acadoWorkspace.A[8778] = acadoWorkspace.evHu[58];
acadoWorkspace.A[8779] = acadoWorkspace.evHu[59];
acadoWorkspace.A[8860] = acadoWorkspace.evHu[60];
acadoWorkspace.A[8861] = acadoWorkspace.evHu[61];
acadoWorkspace.A[8942] = acadoWorkspace.evHu[62];
acadoWorkspace.A[8943] = acadoWorkspace.evHu[63];
acadoWorkspace.A[9024] = acadoWorkspace.evHu[64];
acadoWorkspace.A[9025] = acadoWorkspace.evHu[65];
acadoWorkspace.A[9106] = acadoWorkspace.evHu[66];
acadoWorkspace.A[9107] = acadoWorkspace.evHu[67];
acadoWorkspace.A[9188] = acadoWorkspace.evHu[68];
acadoWorkspace.A[9189] = acadoWorkspace.evHu[69];
acadoWorkspace.A[9270] = acadoWorkspace.evHu[70];
acadoWorkspace.A[9271] = acadoWorkspace.evHu[71];
acadoWorkspace.A[9352] = acadoWorkspace.evHu[72];
acadoWorkspace.A[9353] = acadoWorkspace.evHu[73];
acadoWorkspace.A[9434] = acadoWorkspace.evHu[74];
acadoWorkspace.A[9435] = acadoWorkspace.evHu[75];
acadoWorkspace.A[9516] = acadoWorkspace.evHu[76];
acadoWorkspace.A[9517] = acadoWorkspace.evHu[77];
acadoWorkspace.A[9598] = acadoWorkspace.evHu[78];
acadoWorkspace.A[9599] = acadoWorkspace.evHu[79];
...
acadoWorkspace.lbA[90] = acadoVariables.lbAValues[90] - acadoWorkspace.evH[10];
acadoWorkspace.lbA[91] = acadoVariables.lbAValues[91] - acadoWorkspace.evH[11];
acadoWorkspace.lbA[92] = acadoVariables.lbAValues[92] - acadoWorkspace.evH[12];
acadoWorkspace.lbA[93] = acadoVariables.lbAValues[93] - acadoWorkspace.evH[13];
acadoWorkspace.lbA[94] = acadoVariables.lbAValues[94] - acadoWorkspace.evH[14];
acadoWorkspace.lbA[95] = acadoVariables.lbAValues[95] - acadoWorkspace.evH[15];
acadoWorkspace.lbA[96] = acadoVariables.lbAValues[96] - acadoWorkspace.evH[16];
acadoWorkspace.lbA[97] = acadoVariables.lbAValues[97] - acadoWorkspace.evH[17];
acadoWorkspace.lbA[98] = acadoVariables.lbAValues[98] - acadoWorkspace.evH[18];
acadoWorkspace.lbA[99] = acadoVariables.lbAValues[99] - acadoWorkspace.evH[19];
acadoWorkspace.lbA[100] = acadoVariables.lbAValues[100] - acadoWorkspace.evH[20];
acadoWorkspace.lbA[101] = acadoVariables.lbAValues[101] - acadoWorkspace.evH[21];
acadoWorkspace.lbA[102] = acadoVariables.lbAValues[102] - acadoWorkspace.evH[22];
acadoWorkspace.lbA[103] = acadoVariables.lbAValues[103] - acadoWorkspace.evH[23];
acadoWorkspace.lbA[104] = acadoVariables.lbAValues[104] - acadoWorkspace.evH[24];
acadoWorkspace.lbA[105] = acadoVariables.lbAValues[105] - acadoWorkspace.evH[25];
acadoWorkspace.lbA[106] = acadoVariables.lbAValues[106] - acadoWorkspace.evH[26];
acadoWorkspace.lbA[107] = acadoVariables.lbAValues[107] - acadoWorkspace.evH[27];
acadoWorkspace.lbA[108] = acadoVariables.lbAValues[108] - acadoWorkspace.evH[28];
acadoWorkspace.lbA[109] = acadoVariables.lbAValues[109] - acadoWorkspace.evH[29];
acadoWorkspace.lbA[110] = acadoVariables.lbAValues[110] - acadoWorkspace.evH[30];
acadoWorkspace.lbA[111] = acadoVariables.lbAValues[111] - acadoWorkspace.evH[31];
acadoWorkspace.lbA[112] = acadoVariables.lbAValues[112] - acadoWorkspace.evH[32];
acadoWorkspace.lbA[113] = acadoVariables.lbAValues[113] - acadoWorkspace.evH[33];
acadoWorkspace.lbA[114] = acadoVariables.lbAValues[114] - acadoWorkspace.evH[34];
acadoWorkspace.lbA[115] = acadoVariables.lbAValues[115] - acadoWorkspace.evH[35];
acadoWorkspace.lbA[116] = acadoVariables.lbAValues[116] - acadoWorkspace.evH[36];
acadoWorkspace.lbA[117] = acadoVariables.lbAValues[117] - acadoWorkspace.evH[37];
acadoWorkspace.lbA[118] = acadoVariables.lbAValues[118] - acadoWorkspace.evH[38];
acadoWorkspace.lbA[119] = acadoVariables.lbAValues[119] - acadoWorkspace.evH[39];
...
acadoWorkspace.ubA[90] = acadoVariables.ubAValues[90] - acadoWorkspace.evH[10];
acadoWorkspace.ubA[91] = acadoVariables.ubAValues[91] - acadoWorkspace.evH[11];
acadoWorkspace.ubA[92] = acadoVariables.ubAValues[92] - acadoWorkspace.evH[12];
acadoWorkspace.ubA[93] = acadoVariables.ubAValues[93] - acadoWorkspace.evH[13];
acadoWorkspace.ubA[94] = acadoVariables.ubAValues[94] - acadoWorkspace.evH[14];
acadoWorkspace.ubA[95] = acadoVariables.ubAValues[95] - acadoWorkspace.evH[15];
acadoWorkspace.ubA[96] = acadoVariables.ubAValues[96] - acadoWorkspace.evH[16];
acadoWorkspace.ubA[97] = acadoVariables.ubAValues[97] - acadoWorkspace.evH[17];
acadoWorkspace.ubA[98] = acadoVariables.ubAValues[98] - acadoWorkspace.evH[18];
acadoWorkspace.ubA[99] = acadoVariables.ubAValues[99] - acadoWorkspace.evH[19];
acadoWorkspace.ubA[100] = acadoVariables.ubAValues[100] - acadoWorkspace.evH[20];
acadoWorkspace.ubA[101] = acadoVariables.ubAValues[101] - acadoWorkspace.evH[21];
acadoWorkspace.ubA[102] = acadoVariables.ubAValues[102] - acadoWorkspace.evH[22];
acadoWorkspace.ubA[103] = acadoVariables.ubAValues[103] - acadoWorkspace.evH[23];
acadoWorkspace.ubA[104] = acadoVariables.ubAValues[104] - acadoWorkspace.evH[24];
acadoWorkspace.ubA[105] = acadoVariables.ubAValues[105] - acadoWorkspace.evH[25];
acadoWorkspace.ubA[106] = acadoVariables.ubAValues[106] - acadoWorkspace.evH[26];
acadoWorkspace.ubA[107] = acadoVariables.ubAValues[107] - acadoWorkspace.evH[27];
acadoWorkspace.ubA[108] = acadoVariables.ubAValues[108] - acadoWorkspace.evH[28];
acadoWorkspace.ubA[109] = acadoVariables.ubAValues[109] - acadoWorkspace.evH[29];
acadoWorkspace.ubA[110] = acadoVariables.ubAValues[110] - acadoWorkspace.evH[30];
acadoWorkspace.ubA[111] = acadoVariables.ubAValues[111] - acadoWorkspace.evH[31];
acadoWorkspace.ubA[112] = acadoVariables.ubAValues[112] - acadoWorkspace.evH[32];
acadoWorkspace.ubA[113] = acadoVariables.ubAValues[113] - acadoWorkspace.evH[33];
acadoWorkspace.ubA[114] = acadoVariables.ubAValues[114] - acadoWorkspace.evH[34];
acadoWorkspace.ubA[115] = acadoVariables.ubAValues[115] - acadoWorkspace.evH[35];
acadoWorkspace.ubA[116] = acadoVariables.ubAValues[116] - acadoWorkspace.evH[36];
acadoWorkspace.ubA[117] = acadoVariables.ubAValues[117] - acadoWorkspace.evH[37];
acadoWorkspace.ubA[118] = acadoVariables.ubAValues[118] - acadoWorkspace.evH[38];
acadoWorkspace.ubA[119] = acadoVariables.ubAValues[119] - acadoWorkspace.evH[39];
...
acado_macHxd( &(acadoWorkspace.evHx[ 3 ]), &(acadoWorkspace.sbar[ 3 ]), &(acadoWorkspace.lbA[ 81 ]), &(acadoWorkspace.ubA[ 81 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 6 ]), &(acadoWorkspace.sbar[ 6 ]), &(acadoWorkspace.lbA[ 82 ]), &(acadoWorkspace.ubA[ 82 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 9 ]), &(acadoWorkspace.sbar[ 9 ]), &(acadoWorkspace.lbA[ 83 ]), &(acadoWorkspace.ubA[ 83 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 12 ]), &(acadoWorkspace.sbar[ 12 ]), &(acadoWorkspace.lbA[ 84 ]), &(acadoWorkspace.ubA[ 84 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 15 ]), &(acadoWorkspace.sbar[ 15 ]), &(acadoWorkspace.lbA[ 85 ]), &(acadoWorkspace.ubA[ 85 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 18 ]), &(acadoWorkspace.sbar[ 18 ]), &(acadoWorkspace.lbA[ 86 ]), &(acadoWorkspace.ubA[ 86 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 21 ]), &(acadoWorkspace.sbar[ 21 ]), &(acadoWorkspace.lbA[ 87 ]), &(acadoWorkspace.ubA[ 87 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 24 ]), &(acadoWorkspace.sbar[ 24 ]), &(acadoWorkspace.lbA[ 88 ]), &(acadoWorkspace.ubA[ 88 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 27 ]), &(acadoWorkspace.sbar[ 27 ]), &(acadoWorkspace.lbA[ 89 ]), &(acadoWorkspace.ubA[ 89 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 30 ]), &(acadoWorkspace.sbar[ 30 ]), &(acadoWorkspace.lbA[ 90 ]), &(acadoWorkspace.ubA[ 90 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 33 ]), &(acadoWorkspace.sbar[ 33 ]), &(acadoWorkspace.lbA[ 91 ]), &(acadoWorkspace.ubA[ 91 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 36 ]), &(acadoWorkspace.sbar[ 36 ]), &(acadoWorkspace.lbA[ 92 ]), &(acadoWorkspace.ubA[ 92 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 39 ]), &(acadoWorkspace.sbar[ 39 ]), &(acadoWorkspace.lbA[ 93 ]), &(acadoWorkspace.ubA[ 93 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 42 ]), &(acadoWorkspace.sbar[ 42 ]), &(acadoWorkspace.lbA[ 94 ]), &(acadoWorkspace.ubA[ 94 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 45 ]), &(acadoWorkspace.sbar[ 45 ]), &(acadoWorkspace.lbA[ 95 ]), &(acadoWorkspace.ubA[ 95 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 48 ]), &(acadoWorkspace.sbar[ 48 ]), &(acadoWorkspace.lbA[ 96 ]), &(acadoWorkspace.ubA[ 96 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 51 ]), &(acadoWorkspace.sbar[ 51 ]), &(acadoWorkspace.lbA[ 97 ]), &(acadoWorkspace.ubA[ 97 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 54 ]), &(acadoWorkspace.sbar[ 54 ]), &(acadoWorkspace.lbA[ 98 ]), &(acadoWorkspace.ubA[ 98 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 57 ]), &(acadoWorkspace.sbar[ 57 ]), &(acadoWorkspace.lbA[ 99 ]), &(acadoWorkspace.ubA[ 99 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 60 ]), &(acadoWorkspace.sbar[ 60 ]), &(acadoWorkspace.lbA[ 100 ]), &(acadoWorkspace.ubA[ 100 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 63 ]), &(acadoWorkspace.sbar[ 63 ]), &(acadoWorkspace.lbA[ 101 ]), &(acadoWorkspace.ubA[ 101 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 66 ]), &(acadoWorkspace.sbar[ 66 ]), &(acadoWorkspace.lbA[ 102 ]), &(acadoWorkspace.ubA[ 102 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 69 ]), &(acadoWorkspace.sbar[ 69 ]), &(acadoWorkspace.lbA[ 103 ]), &(acadoWorkspace.ubA[ 103 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 72 ]), &(acadoWorkspace.sbar[ 72 ]), &(acadoWorkspace.lbA[ 104 ]), &(acadoWorkspace.ubA[ 104 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 75 ]), &(acadoWorkspace.sbar[ 75 ]), &(acadoWorkspace.lbA[ 105 ]), &(acadoWorkspace.ubA[ 105 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 78 ]), &(acadoWorkspace.sbar[ 78 ]), &(acadoWorkspace.lbA[ 106 ]), &(acadoWorkspace.ubA[ 106 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 81 ]), &(acadoWorkspace.sbar[ 81 ]), &(acadoWorkspace.lbA[ 107 ]), &(acadoWorkspace.ubA[ 107 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 84 ]), &(acadoWorkspace.sbar[ 84 ]), &(acadoWorkspace.lbA[ 108 ]), &(acadoWorkspace.ubA[ 108 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 87 ]), &(acadoWorkspace.sbar[ 87 ]), &(acadoWorkspace.lbA[ 109 ]), &(acadoWorkspace.ubA[ 109 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 90 ]), &(acadoWorkspace.sbar[ 90 ]), &(acadoWorkspace.lbA[ 110 ]), &(acadoWorkspace.ubA[ 110 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 93 ]), &(acadoWorkspace.sbar[ 93 ]), &(acadoWorkspace.lbA[ 111 ]), &(acadoWorkspace.ubA[ 111 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 96 ]), &(acadoWorkspace.sbar[ 96 ]), &(acadoWorkspace.lbA[ 112 ]), &(acadoWorkspace.ubA[ 112 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 99 ]), &(acadoWorkspace.sbar[ 99 ]), &(acadoWorkspace.lbA[ 113 ]), &(acadoWorkspace.ubA[ 113 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 102 ]), &(acadoWorkspace.sbar[ 102 ]), &(acadoWorkspace.lbA[ 114 ]), &(acadoWorkspace.ubA[ 114 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 105 ]), &(acadoWorkspace.sbar[ 105 ]), &(acadoWorkspace.lbA[ 115 ]), &(acadoWorkspace.ubA[ 115 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 108 ]), &(acadoWorkspace.sbar[ 108 ]), &(acadoWorkspace.lbA[ 116 ]), &(acadoWorkspace.ubA[ 116 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 111 ]), &(acadoWorkspace.sbar[ 111 ]), &(acadoWorkspace.lbA[ 117 ]), &(acadoWorkspace.ubA[ 117 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 114 ]), &(acadoWorkspace.sbar[ 114 ]), &(acadoWorkspace.lbA[ 118 ]), &(acadoWorkspace.ubA[ 118 ]) );
acado_macHxd( &(acadoWorkspace.evHx[ 117 ]), &(acadoWorkspace.sbar[ 117 ]), &(acadoWorkspace.lbA[ 119 ]), &(acadoWorkspace.ubA[ 119 ]) );
...
acadoVariables.mu[117] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[158];
acadoVariables.mu[118] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[159];
acadoVariables.mu[119] = 0.0000000000000000e+00;
acadoVariables.mu[117] += + acadoWorkspace.sbar[120]*acadoWorkspace.QN1[0] + acadoWorkspace.sbar[121]*acadoWorkspace.QN1[3] + acadoWorkspace.sbar[122]*acadoWorkspace.QN1[6];
acadoVariables.mu[118] += + acadoWorkspace.sbar[120]*acadoWorkspace.QN1[1] + acadoWorkspace.sbar[121]*acadoWorkspace.QN1[4] + acadoWorkspace.sbar[122]*acadoWorkspace.QN1[7];
acadoVariables.mu[119] += + acadoWorkspace.sbar[120]*acadoWorkspace.QN1[2] + acadoWorkspace.sbar[121]*acadoWorkspace.QN1[5] + acadoWorkspace.sbar[122]*acadoWorkspace.QN1[8];
acadoVariables.mu[117] += acadoWorkspace.QDy[120];
acadoVariables.mu[118] += acadoWorkspace.QDy[121];
acadoVariables.mu[119] += acadoWorkspace.QDy[122];
acadoVariables.mu[114] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[156];
acadoVariables.mu[114] -= + acadoWorkspace.y[199]*acadoWorkspace.evHx[117];
acadoVariables.mu[115] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[157];
acadoVariables.mu[115] -= + acadoWorkspace.y[199]*acadoWorkspace.evHx[118];
acadoVariables.mu[116] = 0.0000000000000000e+00;
acadoVariables.mu[116] -= + acadoWorkspace.y[199]*acadoWorkspace.evHx[119];
...
acadoVariables.mu[111] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[154];
acadoVariables.mu[111] -= + acadoWorkspace.y[198]*acadoWorkspace.evHx[114];
acadoVariables.mu[112] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[155];
acadoVariables.mu[112] -= + acadoWorkspace.y[198]*acadoWorkspace.evHx[115];
acadoVariables.mu[113] = 0.0000000000000000e+00;
acadoVariables.mu[113] -= + acadoWorkspace.y[198]*acadoWorkspace.evHx[116];
...
acadoVariables.mu[108] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[152];
acadoVariables.mu[108] -= + acadoWorkspace.y[197]*acadoWorkspace.evHx[111];
acadoVariables.mu[109] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[153];
acadoVariables.mu[109] -= + acadoWorkspace.y[197]*acadoWorkspace.evHx[112];
acadoVariables.mu[110] = 0.0000000000000000e+00;
acadoVariables.mu[110] -= + acadoWorkspace.y[197]*acadoWorkspace.evHx[113];
...
acadoVariables.mu[105] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[150];
acadoVariables.mu[105] -= + acadoWorkspace.y[196]*acadoWorkspace.evHx[108];
acadoVariables.mu[106] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[151];
acadoVariables.mu[106] -= + acadoWorkspace.y[196]*acadoWorkspace.evHx[109];
acadoVariables.mu[107] = 0.0000000000000000e+00;
acadoVariables.mu[107] -= + acadoWorkspace.y[196]*acadoWorkspace.evHx[110];
...
acadoVariables.mu[102] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[148];
acadoVariables.mu[102] -= + acadoWorkspace.y[195]*acadoWorkspace.evHx[105];
acadoVariables.mu[103] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[149];
acadoVariables.mu[103] -= + acadoWorkspace.y[195]*acadoWorkspace.evHx[106];
acadoVariables.mu[104] = 0.0000000000000000e+00;
acadoVariables.mu[104] -= + acadoWorkspace.y[195]*acadoWorkspace.evHx[107];
...
acadoVariables.mu[99] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[146];
acadoVariables.mu[99] -= + acadoWorkspace.y[194]*acadoWorkspace.evHx[102];
acadoVariables.mu[100] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[147];
acadoVariables.mu[100] -= + acadoWorkspace.y[194]*acadoWorkspace.evHx[103];
acadoVariables.mu[101] = 0.0000000000000000e+00;
acadoVariables.mu[101] -= + acadoWorkspace.y[194]*acadoWorkspace.evHx[104];
...
acadoVariables.mu[96] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[144];
acadoVariables.mu[96] -= + acadoWorkspace.y[193]*acadoWorkspace.evHx[99];
acadoVariables.mu[97] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[145];
acadoVariables.mu[97] -= + acadoWorkspace.y[193]*acadoWorkspace.evHx[100];
acadoVariables.mu[98] = 0.0000000000000000e+00;
acadoVariables.mu[98] -= + acadoWorkspace.y[193]*acadoWorkspace.evHx[101];
...
acadoVariables.mu[93] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[142];
acadoVariables.mu[93] -= + acadoWorkspace.y[192]*acadoWorkspace.evHx[96];
acadoVariables.mu[94] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[143];
acadoVariables.mu[94] -= + acadoWorkspace.y[192]*acadoWorkspace.evHx[97];
acadoVariables.mu[95] = 0.0000000000000000e+00;
acadoVariables.mu[95] -= + acadoWorkspace.y[192]*acadoWorkspace.evHx[98];
...
acadoVariables.mu[90] -= + acadoWorkspace.y[191]*acadoWorkspace.evHx[93];
acadoVariables.mu[91] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[141];
acadoVariables.mu[91] -= + acadoWorkspace.y[191]*acadoWorkspace.evHx[94];
acadoVariables.mu[92] = 0.0000000000000000e+00;
acadoVariables.mu[92] -= + acadoWorkspace.y[191]*acadoWorkspace.evHx[95];
...
acadoVariables.mu[87] -= + acadoWorkspace.y[190]*acadoWorkspace.evHx[90];
acadoVariables.mu[88] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[139];
acadoVariables.mu[88] -= + acadoWorkspace.y[190]*acadoWorkspace.evHx[91];
acadoVariables.mu[89] = 0.0000000000000000e+00;
acadoVariables.mu[89] -= + acadoWorkspace.y[190]*acadoWorkspace.evHx[92];
...
acadoVariables.mu[84] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[136];
acadoVariables.mu[84] -= + acadoWorkspace.y[189]*acadoWorkspace.evHx[87];
acadoVariables.mu[85] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[137];
acadoVariables.mu[85] -= + acadoWorkspace.y[189]*acadoWorkspace.evHx[88];
acadoVariables.mu[86] = 0.0000000000000000e+00;
acadoVariables.mu[86] -= + acadoWorkspace.y[189]*acadoWorkspace.evHx[89];
...
acadoVariables.mu[81] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[134];
acadoVariables.mu[81] -= + acadoWorkspace.y[188]*acadoWorkspace.evHx[84];
acadoVariables.mu[82] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[135];
acadoVariables.mu[82] -= + acadoWorkspace.y[188]*acadoWorkspace.evHx[85];
acadoVariables.mu[83] = 0.0000000000000000e+00;
acadoVariables.mu[83] -= + acadoWorkspace.y[188]*acadoWorkspace.evHx[86];
...
acadoVariables.mu[78] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[132];
acadoVariables.mu[78] -= + acadoWorkspace.y[187]*acadoWorkspace.evHx[81];
acadoVariables.mu[79] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[133];
acadoVariables.mu[79] -= + acadoWorkspace.y[187]*acadoWorkspace.evHx[82];
acadoVariables.mu[80] = 0.0000000000000000e+00;
acadoVariables.mu[80] -= + acadoWorkspace.y[187]*acadoWorkspace.evHx[83];
...
acadoVariables.mu[75] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[130];
acadoVariables.mu[75] -= + acadoWorkspace.y[186]*acadoWorkspace.evHx[78];
acadoVariables.mu[76] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[131];
acadoVariables.mu[76] -= + acadoWorkspace.y[186]*acadoWorkspace.evHx[79];
acadoVariables.mu[77] = 0.0000000000000000e+00;
acadoVariables.mu[77] -= + acadoWorkspace.y[186]*acadoWorkspace.evHx[80];
...
acadoVariables.mu[72] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[128];
acadoVariables.mu[72] -= + acadoWorkspace.y[185]*acadoWorkspace.evHx[75];
acadoVariables.mu[73] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[129];
acadoVariables.mu[73] -= + acadoWorkspace.y[185]*acadoWorkspace.evHx[76];
acadoVariables.mu[74] = 0.0000000000000000e+00;
acadoVariables.mu[74] -= + acadoWorkspace.y[185]*acadoWorkspace.evHx[77];
...
acadoVariables.mu[69] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[126];
acadoVariables.mu[69] -= + acadoWorkspace.y[184]*acadoWorkspace.evHx[72];
acadoVariables.mu[70] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[127];
acadoVariables.mu[70] -= + acadoWorkspace.y[184]*acadoWorkspace.evHx[73];
acadoVariables.mu[71] = 0.0000000000000000e+00;
acadoVariables.mu[71] -= + acadoWorkspace.y[184]*acadoWorkspace.evHx[74];
...
acadoVariables.mu[66] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[124];
acadoVariables.mu[66] -= + acadoWorkspace.y[183]*acadoWorkspace.evHx[69];
acadoVariables.mu[67] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[125];
acadoVariables.mu[67] -= + acadoWorkspace.y[183]*acadoWorkspace.evHx[70];
acadoVariables.mu[68] = 0.0000000000000000e+00;
acadoVariables.mu[68] -= + acadoWorkspace.y[183]*acadoWorkspace.evHx[71];
...
acadoVariables.mu[63] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[122];
acadoVariables.mu[63] -= + acadoWorkspace.y[182]*acadoWorkspace.evHx[66];
acadoVariables.mu[64] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[123];
acadoVariables.mu[64] -= + acadoWorkspace.y[182]*acadoWorkspace.evHx[67];
acadoVariables.mu[65] = 0.0000000000000000e+00;
acadoVariables.mu[65] -= + acadoWorkspace.y[182]*acadoWorkspace.evHx[68];
...
acadoVariables.mu[60] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[120];
acadoVariables.mu[60] -= + acadoWorkspace.y[181]*acadoWorkspace.evHx[63];
acadoVariables.mu[61] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[121];
acadoVariables.mu[61] -= + acadoWorkspace.y[181]*acadoWorkspace.evHx[64];
acadoVariables.mu[62] = 0.0000000000000000e+00;
acadoVariables.mu[62] -= + acadoWorkspace.y[181]*acadoWorkspace.evHx[65];
...
acadoVariables.mu[57] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[118];
acadoVariables.mu[57] -= + acadoWorkspace.y[180]*acadoWorkspace.evHx[60];
acadoVariables.mu[58] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[119];
acadoVariables.mu[58] -= + acadoWorkspace.y[180]*acadoWorkspace.evHx[61];
acadoVariables.mu[59] = 0.0000000000000000e+00;
acadoVariables.mu[59] -= + acadoWorkspace.y[180]*acadoWorkspace.evHx[62];
...
acadoVariables.mu[54] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[116];
acadoVariables.mu[54] -= + acadoWorkspace.y[179]*acadoWorkspace.evHx[57];
acadoVariables.mu[55] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[117];
acadoVariables.mu[55] -= + acadoWorkspace.y[179]*acadoWorkspace.evHx[58];
acadoVariables.mu[56] = 0.0000000000000000e+00;
acadoVariables.mu[56] -= + acadoWorkspace.y[179]*acadoWorkspace.evHx[59];
...
acadoVariables.mu[51] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[114];
acadoVariables.mu[51] -= + acadoWorkspace.y[178]*acadoWorkspace.evHx[54];
acadoVariables.mu[52] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[115];
acadoVariables.mu[52] -= + acadoWorkspace.y[178]*acadoWorkspace.evHx[55];
acadoVariables.mu[53] = 0.0000000000000000e+00;
acadoVariables.mu[53] -= + acadoWorkspace.y[178]*acadoWorkspace.evHx[56];
...
acadoVariables.mu[48] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[112];
acadoVariables.mu[48] -= + acadoWorkspace.y[177]*acadoWorkspace.evHx[51];
acadoVariables.mu[49] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[113];
acadoVariables.mu[49] -= + acadoWorkspace.y[177]*acadoWorkspace.evHx[52];
acadoVariables.mu[50] = 0.0000000000000000e+00;
acadoVariables.mu[50] -= + acadoWorkspace.y[177]*acadoWorkspace.evHx[53];
...
acadoVariables.mu[45] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[110];
acadoVariables.mu[45] -= + acadoWorkspace.y[176]*acadoWorkspace.evHx[48];
acadoVariables.mu[46] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[111];
acadoVariables.mu[46] -= + acadoWorkspace.y[176]*acadoWorkspace.evHx[49];
acadoVariables.mu[47] = 0.0000000000000000e+00;
acadoVariables.mu[47] -= + acadoWorkspace.y[176]*acadoWorkspace.evHx[50];
...
acadoVariables.mu[42] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[108];
acadoVariables.mu[42] -= + acadoWorkspace.y[175]*acadoWorkspace.evHx[45];
acadoVariables.mu[43] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[109];
acadoVariables.mu[43] -= + acadoWorkspace.y[175]*acadoWorkspace.evHx[46];
acadoVariables.mu[44] = 0.0000000000000000e+00;
acadoVariables.mu[44] -= + acadoWorkspace.y[175]*acadoWorkspace.evHx[47];
...
acadoVariables.mu[39] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[106];
acadoVariables.mu[39] -= + acadoWorkspace.y[174]*acadoWorkspace.evHx[42];
acadoVariables.mu[40] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[107];
acadoVariables.mu[40] -= + acadoWorkspace.y[174]*acadoWorkspace.evHx[43];
acadoVariables.mu[41] = 0.0000000000000000e+00;
acadoVariables.mu[41] -= + acadoWorkspace.y[174]*acadoWorkspace.evHx[44];
...
acadoVariables.mu[36] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[104];
acadoVariables.mu[36] -= + acadoWorkspace.y[173]*acadoWorkspace.evHx[39];
acadoVariables.mu[37] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[105];
acadoVariables.mu[37] -= + acadoWorkspace.y[173]*acadoWorkspace.evHx[40];
acadoVariables.mu[38] = 0.0000000000000000e+00;
acadoVariables.mu[38] -= + acadoWorkspace.y[173]*acadoWorkspace.evHx[41];
...
acadoVariables.mu[33] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[102];
acadoVariables.mu[33] -= + acadoWorkspace.y[172]*acadoWorkspace.evHx[36];
acadoVariables.mu[34] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[103];
acadoVariables.mu[34] -= + acadoWorkspace.y[172]*acadoWorkspace.evHx[37];
acadoVariables.mu[35] = 0.0000000000000000e+00;
acadoVariables.mu[35] -= + acadoWorkspace.y[172]*acadoWorkspace.evHx[38];
...
acadoVariables.mu[30] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[100];
acadoVariables.mu[30] -= + acadoWorkspace.y[171]*acadoWorkspace.evHx[33];
acadoVariables.mu[31] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[101];
acadoVariables.mu[31] -= + acadoWorkspace.y[171]*acadoWorkspace.evHx[34];
acadoVariables.mu[32] = 0.0000000000000000e+00;
acadoVariables.mu[32] -= + acadoWorkspace.y[171]*acadoWorkspace.evHx[35];
...
acadoVariables.mu[27] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[98];
acadoVariables.mu[27] -= + acadoWorkspace.y[170]*acadoWorkspace.evHx[30];
acadoVariables.mu[28] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[99];
acadoVariables.mu[28] -= + acadoWorkspace.y[170]*acadoWorkspace.evHx[31];
acadoVariables.mu[29] = 0.0000000000000000e+00;
acadoVariables.mu[29] -= + acadoWorkspace.y[170]*acadoWorkspace.evHx[32];
...
acadoVariables.mu[24] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[96];
acadoVariables.mu[24] -= + acadoWorkspace.y[169]*acadoWorkspace.evHx[27];
acadoVariables.mu[25] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[97];
acadoVariables.mu[25] -= + acadoWorkspace.y[169]*acadoWorkspace.evHx[28];
acadoVariables.mu[26] = 0.0000000000000000e+00;
acadoVariables.mu[26] -= + acadoWorkspace.y[169]*acadoWorkspace.evHx[29];
...
acadoVariables.mu[21] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[94];
acadoVariables.mu[21] -= + acadoWorkspace.y[168]*acadoWorkspace.evHx[24];
acadoVariables.mu[22] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[95];
acadoVariables.mu[22] -= + acadoWorkspace.y[168]*acadoWorkspace.evHx[25];
acadoVariables.mu[23] = 0.0000000000000000e+00;
acadoVariables.mu[23] -= + acadoWorkspace.y[168]*acadoWorkspace.evHx[26];
...
acadoVariables.mu[18] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[92];
acadoVariables.mu[18] -= + acadoWorkspace.y[167]*acadoWorkspace.evHx[21];
acadoVariables.mu[19] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[93];
acadoVariables.mu[19] -= + acadoWorkspace.y[167]*acadoWorkspace.evHx[22];
acadoVariables.mu[20] = 0.0000000000000000e+00;
acadoVariables.mu[20] -= + acadoWorkspace.y[167]*acadoWorkspace.evHx[23];
...
acadoVariables.mu[15] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[90];
acadoVariables.mu[15] -= + acadoWorkspace.y[166]*acadoWorkspace.evHx[18];
acadoVariables.mu[16] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[91];
acadoVariables.mu[16] -= + acadoWorkspace.y[166]*acadoWorkspace.evHx[19];
acadoVariables.mu[17] = 0.0000000000000000e+00;
acadoVariables.mu[17] -= + acadoWorkspace.y[166]*acadoWorkspace.evHx[20];
...
acadoVariables.mu[12] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[88];
acadoVariables.mu[12] -= + acadoWorkspace.y[165]*acadoWorkspace.evHx[15];
acadoVariables.mu[13] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[89];
acadoVariables.mu[13] -= + acadoWorkspace.y[165]*acadoWorkspace.evHx[16];
acadoVariables.mu[14] = 0.0000000000000000e+00;
acadoVariables.mu[14] -= + acadoWorkspace.y[165]*acadoWorkspace.evHx[17];
...
acadoVariables.mu[9] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[86];
acadoVariables.mu[9] -= + acadoWorkspace.y[164]*acadoWorkspace.evHx[12];
acadoVariables.mu[10] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[87];
acadoVariables.mu[10] -= + acadoWorkspace.y[164]*acadoWorkspace.evHx[13];
acadoVariables.mu[11] = 0.0000000000000000e+00;
acadoVariables.mu[11] -= + acadoWorkspace.y[164]*acadoWorkspace.evHx[14];
...
acadoVariables.mu[6] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[84];
acadoVariables.mu[6] -= + acadoWorkspace.y[163]*acadoWorkspace.evHx[9];
acadoVariables.mu[7] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[85];
acadoVariables.mu[7] -= + acadoWorkspace.y[163]*acadoWorkspace.evHx[10];
acadoVariables.mu[8] = 0.0000000000000000e+00;
acadoVariables.mu[8] -= + acadoWorkspace.y[163]*acadoWorkspace.evHx[11];
...
acadoVariables.mu[3] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[82];
acadoVariables.mu[3] -= + acadoWorkspace.y[162]*acadoWorkspace.evHx[6];
acadoVariables.mu[4] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[83];
acadoVariables.mu[4] -= + acadoWorkspace.y[162]*acadoWorkspace.evHx[7];
acadoVariables.mu[5] = 0.0000000000000000e+00;
acadoVariables.mu[5] -= + acadoWorkspace.y[162]*acadoWorkspace.evHx[8];
...
acadoVariables.mu[0] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[80];
acadoVariables.mu[0] -= + acadoWorkspace.y[161]*acadoWorkspace.evHx[3];
acadoVariables.mu[1] = + (real_t)-1.0000000000000000e+00*acadoWorkspace.y[81];
acadoVariables.mu[1] -= + acadoWorkspace.y[161]*acadoWorkspace.evHx[4];
acadoVariables.mu[2] = 0.0000000000000000e+00;
acadoVariables.mu[2] -= + acadoWorkspace.y[161]*acadoWorkspace.evHx[5];
...
acadoVariables.lbAValues[1] = -1.0000000000000000e+02;
acadoVariables.lbAValues[2] = -1.0000000000000000e+02;
acadoVariables.lbAValues[3] = -1.0000000000000000e+02;
acadoVariables.lbAValues[4] = -1.0000000000000000e+02;
acadoVariables.lbAValues[5] = -1.0000000000000000e+02;
acadoVariables.lbAValues[6] = -1.0000000000000000e+02;
acadoVariables.lbAValues[7] = -1.0000000000000000e+02;
acadoVariables.lbAValues[8] = -1.0000000000000000e+02;
acadoVariables.lbAValues[9] = -1.0000000000000000e+02;
acadoVariables.lbAValues[10] = -1.0000000000000000e+02;
acadoVariables.lbAValues[11] = -1.0000000000000000e+02;
acadoVariables.lbAValues[12] = -1.0000000000000000e+02;
acadoVariables.lbAValues[13] = -1.0000000000000000e+02;
acadoVariables.lbAValues[14] = -1.0000000000000000e+02;
acadoVariables.lbAValues[15] = -1.0000000000000000e+02;
acadoVariables.lbAValues[16] = -1.0000000000000000e+02;
acadoVariables.lbAValues[17] = -1.0000000000000000e+02;
acadoVariables.lbAValues[18] = -1.0000000000000000e+02;
acadoVariables.lbAValues[19] = -1.0000000000000000e+02;
acadoVariables.lbAValues[20] = -1.0000000000000000e+02;
acadoVariables.lbAValues[21] = -1.0000000000000000e+02;
acadoVariables.lbAValues[22] = -1.0000000000000000e+02;
acadoVariables.lbAValues[23] = -1.0000000000000000e+02;
acadoVariables.lbAValues[24] = -1.0000000000000000e+02;
acadoVariables.lbAValues[25] = -1.0000000000000000e+02;
acadoVariables.lbAValues[26] = -1.0000000000000000e+02;
acadoVariables.lbAValues[27] = -1.0000000000000000e+02;
acadoVariables.lbAValues[28] = -1.0000000000000000e+02;
acadoVariables.lbAValues[29] = -1.0000000000000000e+02;
acadoVariables.lbAValues[30] = -1.0000000000000000e+02;
acadoVariables.lbAValues[31] = -1.0000000000000000e+02;
acadoVariables.lbAValues[32] = -1.0000000000000000e+02;
acadoVariables.lbAValues[33] = -1.0000000000000000e+02;
acadoVariables.lbAValues[34] = -1.0000000000000000e+02;
acadoVariables.lbAValues[35] = -1.0000000000000000e+02;
acadoVariables.lbAValues[36] = -1.0000000000000000e+02;
acadoVariables.lbAValues[37] = -1.0000000000000000e+02;
acadoVariables.lbAValues[38] = -1.0000000000000000e+02;
acadoVariables.lbAValues[39] = -1.0000000000000000e+02;
acadoVariables.lbAValues[40] = -1.0000000000000000e+02;
acadoVariables.lbAValues[41] = -1.0000000000000000e+02;
acadoVariables.lbAValues[42] = -1.0000000000000000e+02;
acadoVariables.lbAValues[43] = -1.0000000000000000e+02;
acadoVariables.lbAValues[44] = -1.0000000000000000e+02;
acadoVariables.lbAValues[45] = -1.0000000000000000e+02;
acadoVariables.lbAValues[46] = -1.0000000000000000e+02;
acadoVariables.lbAValues[47] = -1.0000000000000000e+02;
acadoVariables.lbAValues[48] = -1.0000000000000000e+02;
acadoVariables.lbAValues[49] = -1.0000000000000000e+02;
acadoVariables.lbAValues[50] = -1.0000000000000000e+02;
acadoVariables.lbAValues[51] = -1.0000000000000000e+02;
acadoVariables.lbAValues[52] = -1.0000000000000000e+02;
acadoVariables.lbAValues[53] = -1.0000000000000000e+02;
acadoVariables.lbAValues[54] = -1.0000000000000000e+02;
acadoVariables.lbAValues[55] = -1.0000000000000000e+02;
acadoVariables.lbAValues[56] = -1.0000000000000000e+02;
acadoVariables.lbAValues[57] = -1.0000000000000000e+02;
acadoVariables.lbAValues[58] = -1.0000000000000000e+02;
acadoVariables.lbAValues[59] = -1.0000000000000000e+02;
acadoVariables.lbAValues[60] = -1.0000000000000000e+02;
acadoVariables.lbAValues[61] = -1.0000000000000000e+02;
acadoVariables.lbAValues[62] = -1.0000000000000000e+02;
acadoVariables.lbAValues[63] = -1.0000000000000000e+02;
acadoVariables.lbAValues[64] = -1.0000000000000000e+02;
acadoVariables.lbAValues[65] = -1.0000000000000000e+02;
acadoVariables.lbAValues[66] = -1.0000000000000000e+02;
acadoVariables.lbAValues[67] = -1.0000000000000000e+02;
acadoVariables.lbAValues[68] = -1.0000000000000000e+02;
acadoVariables.lbAValues[69] = -1.0000000000000000e+02;
acadoVariables.lbAValues[70] = -1.0000000000000000e+02;
acadoVariables.lbAValues[71] = -1.0000000000000000e+02;
acadoVariables.lbAValues[72] = -1.0000000000000000e+02;
acadoVariables.lbAValues[73] = -1.0000000000000000e+02;
acadoVariables.lbAValues[74] = -1.0000000000000000e+02;
acadoVariables.lbAValues[75] = -1.0000000000000000e+02;
acadoVariables.lbAValues[76] = -1.0000000000000000e+02;
acadoVariables.lbAValues[77] = -1.0000000000000000e+02;
acadoVariables.lbAValues[78] = -1.0000000000000000e+02;
acadoVariables.lbAValues[79] = -1.0000000000000000e+02;
...
acadoVariables.ubAValues[0] = 1.0000000000000000e+02;
acadoVariables.ubAValues[1] = 1.0000000000000000e+02;
acadoVariables.ubAValues[2] = 1.0000000000000000e+02;
acadoVariables.ubAValues[3] = 1.0000000000000000e+02;
acadoVariables.ubAValues[4] = 1.0000000000000000e+02;
acadoVariables.ubAValues[5] = 1.0000000000000000e+02;
acadoVariables.ubAValues[6] = 1.0000000000000000e+02;
acadoVariables.ubAValues[7] = 1.0000000000000000e+02;
acadoVariables.ubAValues[8] = 1.0000000000000000e+02;
acadoVariables.ubAValues[9] = 1.0000000000000000e+02;
acadoVariables.ubAValues[10] = 1.0000000000000000e+02;
acadoVariables.ubAValues[11] = 1.0000000000000000e+02;
acadoVariables.ubAValues[12] = 1.0000000000000000e+02;
acadoVariables.ubAValues[13] = 1.0000000000000000e+02;
acadoVariables.ubAValues[14] = 1.0000000000000000e+02;
acadoVariables.ubAValues[15] = 1.0000000000000000e+02;
acadoVariables.ubAValues[16] = 1.0000000000000000e+02;
acadoVariables.ubAValues[17] = 1.0000000000000000e+02;
acadoVariables.ubAValues[18] = 1.0000000000000000e+02;
acadoVariables.ubAValues[19] = 1.0000000000000000e+02;
acadoVariables.ubAValues[20] = 1.0000000000000000e+02;
acadoVariables.ubAValues[21] = 1.0000000000000000e+02;
acadoVariables.ubAValues[22] = 1.0000000000000000e+02;
acadoVariables.ubAValues[23] = 1.0000000000000000e+02;
acadoVariables.ubAValues[24] = 1.0000000000000000e+02;
acadoVariables.ubAValues[25] = 1.0000000000000000e+02;
acadoVariables.ubAValues[26] = 1.0000000000000000e+02;
acadoVariables.ubAValues[27] = 1.0000000000000000e+02;
acadoVariables.ubAValues[28] = 1.0000000000000000e+02;
acadoVariables.ubAValues[29] = 1.0000000000000000e+02;
acadoVariables.ubAValues[30] = 1.0000000000000000e+02;
acadoVariables.ubAValues[31] = 1.0000000000000000e+02;
acadoVariables.ubAValues[32] = 1.0000000000000000e+02;
acadoVariables.ubAValues[33] = 1.0000000000000000e+02;
acadoVariables.ubAValues[34] = 1.0000000000000000e+02;
acadoVariables.ubAValues[35] = 1.0000000000000000e+02;
acadoVariables.ubAValues[36] = 1.0000000000000000e+02;
acadoVariables.ubAValues[37] = 1.0000000000000000e+02;
acadoVariables.ubAValues[38] = 1.0000000000000000e+02;
acadoVariables.ubAValues[39] = 1.0000000000000000e+02;
acadoVariables.ubAValues[40] = 1.0000000000000000e+02;
acadoVariables.ubAValues[41] = 1.0000000000000000e+02;
acadoVariables.ubAValues[42] = 1.0000000000000000e+02;
acadoVariables.ubAValues[43] = 1.0000000000000000e+02;
acadoVariables.ubAValues[44] = 1.0000000000000000e+02;
acadoVariables.ubAValues[45] = 1.0000000000000000e+02;
acadoVariables.ubAValues[46] = 1.0000000000000000e+02;
acadoVariables.ubAValues[47] = 1.0000000000000000e+02;
acadoVariables.ubAValues[48] = 1.0000000000000000e+02;
acadoVariables.ubAValues[49] = 1.0000000000000000e+02;
acadoVariables.ubAValues[50] = 1.0000000000000000e+02;
acadoVariables.ubAValues[51] = 1.0000000000000000e+02;
acadoVariables.ubAValues[52] = 1.0000000000000000e+02;
acadoVariables.ubAValues[53] = 1.0000000000000000e+02;
acadoVariables.ubAValues[54] = 1.0000000000000000e+02;
acadoVariables.ubAValues[55] = 1.0000000000000000e+02;
acadoVariables.ubAValues[56] = 1.0000000000000000e+02;
acadoVariables.ubAValues[57] = 1.0000000000000000e+02;
acadoVariables.ubAValues[58] = 1.0000000000000000e+02;
acadoVariables.ubAValues[59] = 1.0000000000000000e+02;
acadoVariables.ubAValues[60] = 1.0000000000000000e+02;
acadoVariables.ubAValues[61] = 1.0000000000000000e+02;
acadoVariables.ubAValues[62] = 1.0000000000000000e+02;
acadoVariables.ubAValues[63] = 1.0000000000000000e+02;
acadoVariables.ubAValues[64] = 1.0000000000000000e+02;
acadoVariables.ubAValues[65] = 1.0000000000000000e+02;
acadoVariables.ubAValues[66] = 1.0000000000000000e+02;
acadoVariables.ubAValues[67] = 1.0000000000000000e+02;
acadoVariables.ubAValues[68] = 1.0000000000000000e+02;
acadoVariables.ubAValues[69] = 1.0000000000000000e+02;
acadoVariables.ubAValues[70] = 1.0000000000000000e+02;
acadoVariables.ubAValues[71] = 1.0000000000000000e+02;
acadoVariables.ubAValues[72] = 1.0000000000000000e+02;
acadoVariables.ubAValues[73] = 1.0000000000000000e+02;
acadoVariables.ubAValues[74] = 1.0000000000000000e+02;
acadoVariables.ubAValues[75] = 1.0000000000000000e+02;
acadoVariables.ubAValues[76] = 1.0000000000000000e+02;
acadoVariables.ubAValues[77] = 1.0000000000000000e+02;
acadoVariables.ubAValues[78] = 1.0000000000000000e+02;
...
{
acadoWorkspace.state[36] = acadoVariables.u[78];
acadoWorkspace.state[37] = acadoVariables.u[79];
}
acadoWorkspace.state[38] = acadoVariables.od[760];
acadoWorkspace.state[39] = acadoVariables.od[761];
acadoWorkspace.state[40] = acadoVariables.od[762];
acadoWorkspace.state[41] = acadoVariables.od[763];
acadoWorkspace.state[42] = acadoVariables.od[764];
acadoWorkspace.state[43] = acadoVariables.od[765];
acadoWorkspace.state[44] = acadoVariables.od[766];
acadoWorkspace.state[45] = acadoVariables.od[767];
acadoWorkspace.state[46] = acadoVariables.od[768];
acadoWorkspace.state[47] = acadoVariables.od[769];
acadoWorkspace.state[48] = acadoVariables.od[770];
acadoWorkspace.state[49] = acadoVariables.od[771];
acadoWorkspace.state[50] = acadoVariables.od[772];
acadoWorkspace.state[51] = acadoVariables.od[773];
acadoWorkspace.state[52] = acadoVariables.od[774];
acadoWorkspace.state[53] = acadoVariables.od[775];
acadoWorkspace.state[54] = acadoVariables.od[776];
acadoWorkspace.state[55] = acadoVariables.od[777];
acadoWorkspace.state[56] = acadoVariables.od[778];
