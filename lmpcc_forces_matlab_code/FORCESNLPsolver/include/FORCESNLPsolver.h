...
/* Generated by FORCES PRO v3.0.0 on Wednesday, April 15, 2020 at 12:44:52 PM */
...
{
    /* vector of size 105 */
    FORCESNLPsolver_float x0[105];

    /* vector of size 4 */
    FORCESNLPsolver_float xinit[4];

    /* vector of size 870 */
    FORCESNLPsolver_float all_parameters[870];
...
typedef struct
{
    ...
    /* vector of size 7 */
    FORCESNLPsolver_float x13[7];

    /* vector of size 7 */
    FORCESNLPsolver_float x14[7];

    /* vector of size 7 */
    FORCESNLPsolver_float x15[7];
...
/* Time of Solver Generation: (UTC) Wednesday, April 15, 2020 12:44:54 PM */
/* User License expires on: (UTC) Wednesday, October 14, 2020 10:00:00 PM (approx.) (at the time of code generation) */
/* Solver Static License expires on: (UTC) Wednesday, October 14, 2020 10:00:00 PM (approx.) */
/* Solver Generation Request Id: dc134a76-5de0-40fe-be25-cd2cd4aaaded */
