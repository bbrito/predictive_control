...
class StaticObstacles:
    ...
    def allowed_static_obstacles(self, object_id):

        rospy.loginfo("Calling static obstacle service ... ")
        rospy.wait_for_service("/arm/pd_control/allowed_static_obstacles")
        rospy.loginfo("Now all services are available ... ")

        print ('\033[94m' + " ----- allowed_static_obstacles obstracles... ----- " + '\033[0m')
        client = rospy.ServiceProxy("/arm/pd_control/allowed_static_obstacles", predictive_control.srv.StaticObstacle)
        request = predictive_control.srv.StaticObstacleRequest()
        response = predictive_control.srv.StaticObstacleResponse()
    ...
    def disallowed_static_obstacles(self, object_id):

        rospy.loginfo("Calling static obstacle service ... ")
        rospy.wait_for_service("/arm/pd_control/disallowed_static_obstacles")
        rospy.loginfo("Now all services are available ... ")

        print ('\033[94m' + " ----- disallowed_static_obstacles obstracles... ----- " + '\033[0m')
        client = rospy.ServiceProxy("/arm/pd_control/disallowed_static_obstacles", predictive_control.srv.StaticObstacle)
        request = predictive_control.srv.StaticObstacleRequest()
        response = predictive_control.srv.StaticObstacleResponse()
...
if __name__ == '__main__':
    ...
    rospy.sleep(15.0)
    OBJECT.allowed_static_obstacles(object_id=object_id)
